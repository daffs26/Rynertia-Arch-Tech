...
export const Team: React.FC = () => {
  ...
  return (
    <section id="team" className="py-14 sm:py-24 bg-white dark:bg-slate-950 relative transition-colors duration-200">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8">
          ...
          <button
            ...
            className={`flex-1 sm:flex-initial px-3.5 sm:px-5 py-2.5 rounded-xl text-xs sm:text-sm font-semibold flex items-center justify-center gap-1.5 sm:gap-2 transition-all cursor-pointer min-h-[44px] whitespace-nowrap ${
              viewMode === 'chart'
                ...
                : 'bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-800 hover:border-blue-300 dark:hover:border-blue-700 hover:text-blue-600 dark:hover:text-blue-400 shadow-sm'
            }`}
          >
        ...
        {/* ── VIEW SECTIONS: ORGANIZATIONAL CHART vs GRID ────────── */}
        <AnimatePresence mode="wait">
          {viewMode === 'chart' ? (
            ...
            >
              {/* Chart Canvas Card */}
              <div className="glass-card rounded-3xl p-4 sm:p-10 border border-slate-200/90 dark:border-slate-800 shadow-xl bg-slate-50/40 dark:bg-slate-900/40 relative overflow-x-auto">
              {/* Chart Branding Header */}
              <div className="text-center pb-8 mb-8 border-b border-slate-200/80 dark:border-slate-800">
                ...
                <p className="text-xs font-semibold uppercase tracking-[0.25em] text-blue-600 dark:text-blue-400 mt-0.5">
              ...
              <div className="mb-14">
                <div className="flex items-center gap-3 mb-6">
                  <span className="px-3.5 py-1 rounded-lg bg-slate-900 dark:bg-slate-800 text-white text-[10px] font-bold uppercase tracking-widest shadow-sm border border-transparent dark:border-slate-700">
                ...
                <div className="flex flex-col items-center space-y-6">
                  ...
                  <Link
                    ...
                    className="relative group min-w-[280px] sm:min-w-[340px] text-center bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-md hover:shadow-xl hover:border-rose-300 dark:hover:border-rose-500/50 hover:scale-[1.02] transition-all cursor-pointer block"
                  >
                    ...
                    <h4 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition">
                      Andi Ryaas Saputra Effendy
                    </h4>
                    <span className="text-[11px] text-slate-400 dark:text-slate-500 group-hover:text-slate-600 dark:group-hover:text-slate-300 transition block mt-0.5">
                      {language === 'id' ? 'Klik untuk melihat profil & biodata' : 'Click to view profile & biodata'}
                    </span>
                  </Link>

                  {/* Connecting Vertical Stem */}
                  <div className="w-0.5 h-6 bg-slate-300 dark:bg-slate-700 relative" />
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full max-w-2xl">
                    ...
                    <Link
                      ...
                      className="relative group text-center bg-white dark:bg-slate-900 p-4.5 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-md hover:shadow-xl hover:border-indigo-300 dark:hover:border-indigo-500/50 hover:scale-[1.02] transition-all cursor-pointer block"
                    >
                      <div className="flex items-center justify-center gap-1 mb-1">
                      ...
                      <h4 className="text-sm sm:text-base font-bold text-slate-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 overflow-hidden shadow-md flex flex-col justify-between">
                    ...
                    <div className="p-5 space-y-4 flex-1">
                      ...
                      <Link
                        href={`/${language}/team/syaamil`}
                        className="flex items-start justify-between gap-2 border-b border-slate-100 dark:border-slate-800 pb-3 hover:text-blue-600 dark:hover:text-blue-400 transition group"
                      >
                        <span className="text-[10px] font-bold uppercase text-slate-400 dark:text-slate-500 tracking-wider">
                          {language === 'id' ? 'PIMPINAN' : 'LEAD'}
                        </span>
                        <span className="text-xs font-bold text-slate-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 text-right flex items-center gap-1">
                          Muhammad Syaamil Muzhaffar
                          <ArrowUpRight className="w-3 h-3 text-blue-600 dark:text-blue-400 opacity-0 group-hover:opacity-100 transition" />
                        </span>
                      </Link>

                      {/* Members */}
                      <div>
                        <span className="block text-[10px] font-bold uppercase text-slate-400 dark:text-slate-500 tracking-wider mb-2">
                          {language === 'id' ? 'ANGGOTA' : 'MEMBERS'}
                        </span>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                          <Link
                            href={`/${language}/team/daffa`}
                            className="px-3 py-2 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/80 text-xs font-semibold text-slate-800 dark:text-slate-200 text-center hover:border-blue-300 dark:hover:border-blue-500 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-blue-50/50 dark:hover:bg-blue-900/30 transition"
                          >
                  ...
                  <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 overflow-hidden shadow-md flex flex-col justify-between">
                    ...
                    <div className="p-5 space-y-4 flex-1">
                      ...
                      <div className="space-y-2 border-b border-slate-100 dark:border-slate-800 pb-3">
                        <Link
                          href={`/${language}/team/femas`}
                          className="flex items-start justify-between gap-2 hover:text-orange-600 dark:hover:text-orange-400 transition group"
                        >
                          <span className="text-[10px] font-bold uppercase text-slate-400 dark:text-slate-500 tracking-wider">
                            {language === 'id' ? 'PIMPINAN, PEMASARAN' : 'LEAD, MARKETING'}
                          </span>
                          <span className="text-xs font-bold text-slate-900 dark:text-white group-hover:text-orange-600 dark:group-hover:text-orange-400 text-right flex items-center gap-1">
                            Femas Hernanda
                            <ArrowUpRight className="w-3 h-3 text-orange-600 dark:text-orange-400 opacity-0 group-hover:opacity-100 transition" />
                          </span>
                        </Link>
                        <Link
                          href={`/${language}/team/firdaus`}
                          className="flex items-start justify-between gap-2 hover:text-amber-600 dark:hover:text-amber-400 transition group"
                        >
                          <span className="text-[10px] font-bold uppercase text-slate-400 dark:text-slate-500 tracking-wider">
                            {language === 'id' ? 'PIMPINAN, DESAIN' : 'LEAD, DESIGN'}
                          </span>
                          <span className="text-xs font-bold text-slate-900 dark:text-white group-hover:text-amber-600 dark:group-hover:text-amber-400 text-right flex items-center gap-1">
                            Muhammad Firdaus
                            <ArrowUpRight className="w-3 h-3 text-amber-600 dark:text-amber-400 opacity-0 group-hover:opacity-100 transition" />
                          </span>
                        </Link>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                          <Link
                            ...
                            className="px-3 py-2 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/80 text-xs font-semibold text-slate-800 dark:text-slate-200 text-center hover:border-orange-300 dark:hover:border-orange-500 hover:text-orange-600 dark:hover:text-orange-400 hover:bg-orange-50/50 dark:hover:bg-orange-900/30 transition"
                          >
                            Naila Al Jasmine
                          </Link>
                          <Link
                  ...
                  <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 overflow-hidden shadow-md flex flex-col justify-between">
                    ...
                    <div className="p-5 space-y-4 flex-1">
                      ...
                      <div className="space-y-2 border-b border-slate-100 dark:border-slate-800 pb-3">
                        <Link
                          href={`/${language}/team/puterarayhan`}
                          className="flex items-start justify-between gap-2 hover:text-emerald-600 dark:hover:text-emerald-400 transition group"
                        >
                          <span className="text-[10px] font-bold uppercase text-slate-400 dark:text-slate-500 tracking-wider">
                            {language === 'id' ? 'PIMPINAN, ANALISIS' : 'LEAD, ANALYSIS'}
                          </span>
                          <span className="text-xs font-bold text-slate-900 dark:text-white group-hover:text-emerald-600 dark:group-hover:text-emerald-400 text-right flex items-center gap-1">
                            Putera Rayhan Hidayat
                            <ArrowUpRight className="w-3 h-3 text-emerald-600 dark:text-emerald-400 opacity-0 group-hover:opacity-100 transition" />
                          </span>
                        </Link>
                        <Link
                          href={`/${language}/team/mikhanaftali`}
                          className="flex items-start justify-between gap-2 hover:text-rose-600 dark:hover:text-rose-400 transition group"
                        >
                          <span className="text-[10px] font-bold uppercase text-slate-400 dark:text-slate-500 tracking-wider">
                            {language === 'id' ? 'PIMPINAN, RISET' : 'LEAD, RESEARCH'}
                          </span>
                          <span className="text-xs font-bold text-slate-900 dark:text-white group-hover:text-rose-600 dark:group-hover:text-rose-400 text-right flex items-center gap-1">
                            Mikha Naftali
                            <ArrowUpRight className="w-3 h-3 text-rose-600 dark:text-rose-400 opacity-0 group-hover:opacity-100 transition" />
                          </span>
                        </Link>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="px-3 py-2 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/80 text-xs font-semibold text-slate-400 dark:text-slate-500 text-center italic">
              ...
              {/* Chart Bottom Label */}
              <div className="text-center pt-8 mt-10 border-t border-slate-200 dark:border-slate-800 text-[11px] text-slate-400 dark:text-slate-500 font-medium">
          ...
          >
            ...
            {/* Department Arched Portrait Cards Grid with Smooth Tab Transition */}
            <AnimatePresence mode="wait">
              <motion.div
                key={activeTab}
                initial="hidden"
