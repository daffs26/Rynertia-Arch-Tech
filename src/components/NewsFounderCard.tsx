...
export const NewsFounderCard: React.FC<NewsFounderCardProps> = ({ article }) => {
  ...
  return (
    <div className="bg-white p-4 sm:p-5 rounded-3xl border border-slate-200/80 shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 flex flex-col h-full group">
      {/* Top Rounded Image */}
      <Link href={articleHref} className="block overflow-hidden rounded-2xl aspect-[16/10] bg-slate-100 mb-4 shrink-0">
        <img
      ...
      <div className="mt-auto pt-3 border-t border-slate-100 flex items-center justify-between gap-2">
        ...
        {author && (
          ...
          >
            ...
            <div className="w-5 h-5 rounded-full overflow-hidden bg-slate-200 shrink-0 ring-1 ring-slate-300">
