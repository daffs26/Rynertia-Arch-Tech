            ...
            {enterpriseSolutions.map(sol => {
              ...
              return (
                <StaggerItem key={sol.id}>
                  <div className="bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 rounded-3xl p-6 sm:p-10 shadow-sm hover:shadow-md transition-all duration-200 space-y-8">
                    {/* Solution Header */}
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 dark:border-slate-800 pb-6">
                      <div className="space-y-1.5">
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 dark:bg-blue-950/50 border border-blue-200/60 dark:border-blue-900/50 text-xs font-semibold text-blue-700 dark:text-blue-300">
                          <span>{sector}</span>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 relative">
                      ...
                      <div className="bg-rose-50/50 dark:bg-rose-950/20 border border-rose-200/80 dark:border-rose-900/40 rounded-2xl p-5 space-y-2.5 flex flex-col justify-between">
                      ...
                      <div className="bg-sky-50/50 dark:bg-sky-950/20 border border-sky-200/80 dark:border-sky-900/40 rounded-2xl p-5 space-y-2.5 flex flex-col justify-between">
                        <div className="space-y-2">
                      ...
                      <div className="bg-indigo-50/50 dark:bg-indigo-950/20 border border-indigo-200/80 dark:border-indigo-900/40 rounded-2xl p-5 space-y-2.5 flex flex-col justify-between">
                        <div className="space-y-2">
                      ...
                      <div className="bg-emerald-50/50 dark:bg-emerald-950/20 border border-emerald-200/80 dark:border-emerald-900/40 rounded-2xl p-5 space-y-2.5 flex flex-col justify-between">
                        <div className="space-y-2">
                    ...
                    <div className="pt-2 flex flex-col lg:flex-row lg:items-center justify-between gap-4 border-t border-slate-100 dark:border-slate-800">
                      {/* Metrics */}
